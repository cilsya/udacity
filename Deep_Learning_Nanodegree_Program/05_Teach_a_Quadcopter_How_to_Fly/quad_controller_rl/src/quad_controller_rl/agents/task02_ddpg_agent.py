...
from quad_controller_rl.agents.task02_ddpg_actor import Actor
from quad_controller_rl.agents.task02_ddpg_critic import Critic
...
class Task02_DDPG(BaseAgent):
    ...
    def __init__(self, task):
        ...
        self.state_size = 2  # position only and velocity
        ...
        self.state_range = np.append(self.state_range[2:3], self.state_range[-1:])
        self.action_range = self.action_range[2:3]
        ...
        self.model_dir = util.get_param('out') +'/task02' # you can use a separate subdirectory for each task and/or neural net architecture
        ...
        if self.load_weights:
            try:
                ...
                # 2018-02-19_15-18-18 - This seems to work for hovering.
                date_of_file = '2018-02-20_12-43-46'
                ...
                self.critic_filename_target =  os.path.join(self.model_dir,'my-model_{}_critic_target.h5'.format(date_of_file))
                ...
                self.actor_target.model.load_weights(self.actor_filename_target)
                self.critic_target.model.load_weights(self.critic_filename_target)
    ...
    def step(self, state, reward, done):
        ...
        if done:
            ...
            try:
                ...
                print("DEBUG - Could not learn experiences.")
    ...
    def preprocess_state(self, state):
            ...
            new_state = np.append( state[2:3], state[-1:] )
