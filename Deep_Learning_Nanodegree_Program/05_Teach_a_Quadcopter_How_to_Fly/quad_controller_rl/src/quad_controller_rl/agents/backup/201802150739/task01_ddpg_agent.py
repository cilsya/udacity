    ...
    def __init__(self, task):
        ...
        if self.load_weights and os.path.isfile(self.actor_filename_local):
            try:
                ...
                # date_of_file = ''
                # self.actor_filename_local = 'my-model_{}_actor_local.h5'.format(date_of_file)
                # self.critic_filename_local =  'my-model_{}_critic_local.h5'.format(date_of_file)
                # self.actor_filename_target =  'my-model_{}_actor_target.h5'.format(date_of_file)
                # self.critic_filename_target =  'my-model_{}_critic_local.h5'.format(date_of_file)
