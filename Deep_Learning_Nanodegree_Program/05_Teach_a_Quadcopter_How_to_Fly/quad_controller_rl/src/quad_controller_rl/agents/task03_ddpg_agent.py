...
from quad_controller_rl.agents.task03_ddpg_actor import Actor
from quad_controller_rl.agents.task03_ddpg_critic import Critic
...
class Task03_DDPG(BaseAgent):
    ...
    def __init__(self, task):
        ...
        date_of_file = '2018-02-20_21-03-41'
        #
        self.save_weights_every = 1  # save weights every n episodes, None to disable
        self.model_dir = util.get_param('out') +'/task03' # you can use a separate subdirectory for each task and/or neural net architecture
