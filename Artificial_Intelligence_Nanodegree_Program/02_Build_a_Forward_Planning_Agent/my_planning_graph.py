...
class PlanningGraph:
    ...
    def my_level_cost(self, in_goal):
        """
        From heuristics.md
        """
    ...
    def h_levelsum(self):
        ...
        for goal in self.goal:
            costs.append( self.my_level_cost(goal) )
        return sum(costs)
    ...
    def h_setlevel(self):
        ...
        #--------------------------------------
        # Using enumeration instead to have 
        # incrementation handled automatically.
        # (Start)
        #--------------------------------------
        ...
        #---------------
        # Extend graph as need be
        # (Start)
        #---------------
        
        # Using enumeration instead to have incrementation handled automatically.
        #self.fill()
        for i, layer in enumerate(self.literal_layers):
            all_goals_met = True
